...
class Theme private constructor() {
    ...
    companion object {
        ...
        val DEFAULT_BOARD_TILE_SELECTED_COLOR: Color = Color.GREEN
        ...
        var BOARD_TILE_SELECTED_COLOR: Color = DEFAULT_BOARD_TILE_SELECTED_COLOR
        ...
        fun select(name: String) {
            ...
            BOARD_TILE_WHITE_COLOR = Color(
                properties.getOrDefault("board.tile.white.color", DEFAULT_BOARD_TILE_WHITE_COLOR.rgb).toString()
                    .toInt(16)
            )
            BOARD_TILE_BLACK_COLOR = Color(
                properties.getOrDefault("board.tile.black.color", DEFAULT_BOARD_TILE_BLACK_COLOR.rgb).toString()
                    .toInt(16)
            )
            BOARD_TILE_SELECTED_COLOR = Color(
                properties.getOrDefault("board.tile.selected.color", DEFAULT_BOARD_TILE_SELECTED_COLOR.rgb)
                    .toString().toInt(16)
            )
            BOARD_PIECE_WHITE_COLOR = Color(
                properties.getOrDefault("board.piece.white.color", DEFAULT_BOARD_PIECE_WHITE_COLOR.rgb).toString()
                    .toInt(16)
            )
            BOARD_PIECE_BLACK_COLOR = Color(
                properties.getOrDefault("board.piece.black.color", DEFAULT_BOARD_PIECE_BLACK_COLOR.rgb).toString()
                    .toInt(16)
            )
        }
